...
BrainForgeMD is an original project directed and maintained by **Sébastien Dubé**.

The project idea, intended use, product direction, priorities, approvals, and final decisions are attributed to Sébastien Dubé. The development itself has been **AI-assisted**, and this document states that openly.
...
**Final project responsibility and maintenance rest with Sébastien Dubé.**
...
BrainForgeMD est un projet original dirigé et maintenu par **Sébastien Dubé**.

L’idée du projet, son usage visé, sa direction, ses priorités, les approbations et les décisions finales sont attribuées à Sébastien Dubé. Le développement lui-même a été **assisté par IA**, et ce document le dit ouvertement.
...
**La responsabilité finale du projet et sa maintenance reviennent à Sébastien Dubé.**
