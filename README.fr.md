...
BrainForgeMD est un projet original de **Sébastien Dubé**. L’idée, la direction du produit, les exigences, les priorités, les approbations et les décisions finales sont attribuées à Sébastien Dubé.

Le développement a été **assisté par IA**. OpenAI ChatGPT a servi pour l’architecture, l’implémentation, les tests, les audits, la documentation et le travail dans le dépôt GitHub, sous la direction de Sébastien Dubé.

Cela ne signifie pas que chaque ligne a été tapée manuellement. Cela ne signifie pas non plus qu’un système d’IA possède ou maintient le projet. La responsabilité finale du projet et sa maintenance reviennent à **Sébastien Dubé**.
